      ...
      <section class="home">
        <v-layout wrap fill-height>
            ...
            <v-card flat class="home-text-card" style="background: transparent">
              <div class="d-block">
                ...
                <p class="subheading" style="line-height: 1.8">
                  Over the past 6 years, as a Designer and front-end developer,
                  I've worked with clients and entrepreneurs to successfully
          ...
          >
            ...
            >
              <v-img class="profile-img" src="/photos/profile-pic.png" />
            </v-lazy>
          </v-flex>
        </v-layout>
      </section>
